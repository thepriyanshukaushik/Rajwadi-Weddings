  ...
  return (
    <div className='w-full h-auto overflow-x-hidden'>
      ...
      <div className='relative'>
        <div data-scroll data-scroll-speed="-.4" className='w-full h-[100vh] bg-[url("/images/lovenotes.jpg")] bg-cover bg-center bg-no-repeat'></div>
        <h1 data-scroll data-scroll-speed="3" className='w-full uppercase font-[Shancalluna] text-[50px] sm:text-[65px] absolute top-[55%] left-[10%] z-[20] text-white font-normal tracking-tighter'>
          Love notes
        </h1>
      </div>

      <div data-scroll data-scroll-speed="-.5" className='w-full flex justify-start items-center flex-col gap-[25px] py-[90px] sm:py-[100px]'>
        <h1 className='font-[Sevillana] font-medium text-[45px] sm:text-[55px] text-[#102C57] text-center'>Words of Appreciation</h1>

        <div className='flex flex-col gap-[30px] items-center'>
          <p className='font-[Poppins] mx-4 sm:mx-32 text-center leading-[30px] text-[14px] sm:text-[16px] text-[#006989] font-light p-4 mt-4'>
          ...
          <img data-scroll data-scroll-speed="-.4" className='w-[70vw] sm:w-[40vw] lg:w-[30vw] xl:w-[20vw] h-[450px] shadow-xl my-8' src="/images/couple1.jpg" alt="Couple 1" />
